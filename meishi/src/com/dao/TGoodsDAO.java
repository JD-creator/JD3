...
public class TGoodsDAO extends HibernateDaoSupport
{
	...
	public static final String GOODS_JIAGE = "goodsJiage";

	public static final String GOODS_CATELOG_ID = "goodsCatelogId";

	public static final String GOODS_CANGUAN_ID = "goodsCanguanId";
	...
	public List findByGoodsJiage(Object goodsJiage)
	{
		return findByProperty(GOODS_JIAGE, goodsJiage);
	}
	...
	public List findByGoodsCanguanId(Object goodsCanguanId)
	{
		return findByProperty(GOODS_CANGUAN_ID, goodsCanguanId);
	}

	public List findByGoodsDel(Object goodsDel)
	{
		return findByProperty(GOODS_DEL, goodsDel);
	}
